                                                ...
                                                success = {
                                                    Toast.makeText(
                                                        ...
                                                        resources.getQuantityString(
                                                            R.plurals.toast_songs_added_toList, songsQty, selectedListName),
                                                        Toast.LENGTH_SHORT
                                                    ).show()
                                                })
                                    ...
                                    cancAPI.insertToList(listID!!, strSelectedSongs,
                                        success = {
                                            Toast.makeText(applicationContext,resources.getQuantityString(
                                                R.plurals.toast_songs_added_toList, songsQty, selectedListName),Toast.LENGTH_SHORT).show()
                                        })
                                }
                                refreshAll()
        ...
        if(selectedFilters.isNotEmpty()) {
            var drawable =
                ResourcesCompat.getDrawable(resources,
                    R.drawable.ic_show_filters, null)
