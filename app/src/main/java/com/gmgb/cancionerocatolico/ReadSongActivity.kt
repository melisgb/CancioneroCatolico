...
import com.gmgb.cancionerocatolico.objects.LyricsLine
import com.gmgb.cancionerocatolico.objects.Note
import com.gmgb.cancionerocatolico.utils.Lyrics
                                        ...
                                        cancAPI.insertToList(listID!!, songID.toString(),
                                            success = {
                                                Toast.makeText(applicationContext,getString(
                                                    R.string.toast_song_added_toList, selectedListName),Toast.LENGTH_SHORT).show()
                                            })
                                    })
                            }
                            else {
